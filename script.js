...
const reportsData = {
  ...
  "bai4": {
    ...
    "bodyHtml": "<div class=\"pdf-page-block\" data-page=\"0\"><h4>BÁO C ÁO C Á NH ÂN</h4><h4>KỸ NĂNG GIAO TI ẾP VÀ HỢP TÁC S Ố</h4><p>Thông tin chung</p><ul><li><strong class=\"label-highlight\">Dự án:</strong> Xây dựng Hệ thống đấu giá (Client-Server, M VC)</li><li><strong class=\"label-highlight\">Vai tr ò:</strong> Lập trình vi ên Client  & Server Controller</li></ul><h3>I. Kỹ năng thi ết lập & S ử dụng công c ụ</h3><p>Trong d ự án này, nh óm ch úng em ch ọn hướng tiếp cận “Tinh gọn”, không l ạm dụng qu á nhi ều</p><p>phần mềm mà tập trung khai th ác tối đa 3 c ông c ụ cốt lõi để duy trì hiệu suất:</p><h4>1. Discord – Messenger (Giao ti ếp, Điều ph ối và Quản lý tác vụ)</h4><ul><li><strong class=\"label-highlight\">Thiết lập:</strong> Tạo 1 s erver Discord n ội bộ để quản lý các công vi ệc theo tiến độ, sử dụng</li></ul><p>Messenger và tạo nhóm để giao ti ếp với các thành vi ên kh ác về các vấn dề khi tri ển khai</p><p>công vi ệc và cần tính nhanh ch óng v à tiện dụng.</p><div class=\"report-img-wrapper\"><img src=\"assets/extracted_media/bai4_image1.png\" alt=\"Minh họa 1\"><p class=\"report-img-caption\">Hình 1: Minh chứng trong file báo cáo</p></div></div><div class=\"pdf-page-block\" data-page=\"1\"><ul><li><strong class=\"label-highlight\">Tối ưu h oá:</strong> Nhóm  em đã sử dụng tính năng G him tin nh ắn của Discord như một bảng</li></ul><p>quản lý Task. Những quyết định chốt tính n ăng hay phân công nhiêm v ụ đều được ghi m</p><p>lại, giúp các th ành vi ên có thể đọc ngay l ập tức mà không phải lướt tìm lại.</p><h4>2. Githu b (Quản lý mã ngu ồn và phiên bản)</h4><ul><li><strong class=\"label-highlight\">Thiết lập:</strong> Khởi tạo Repository d ùng chung Online -Auction -system-Group7 -CS6 với cấu</li></ul><p>trúc đa m odule ( Aution_client, Aut ion_server) .</p><ul><li><strong class=\"label-highlight\">Tối ưu h oá không gian:</strong> Chún g em t ổ chức luồng công vi ệc thông qua  nhánh (Branch ).</li></ul><p><strong class=\"label-highlight\">Quy t ắc lưu tr ữ:</strong> Toàn b ộ mã ngu ồn đư ợc đặt tên chu ẩn CamelCase c ủa Java (VD:</p><p>LoginController.java ). Các  giao di ện FXML đư ợc gom chung vào thư m ục</p><p>resources/com/auction/client  giúp h ệ thống thư m ục gọn gàng, d ễ truy xu ất. Mỗi thành v iên</p><p>có nhánh ri êng ( Ví dụ em c ó nhánh riêng Va nDuc ). Mã nguồn chỉ được phép đẩy lên nh ánh</p><p>cá nhân, sau đó em s ẽ kiểm tra logic tr ước khi gộp vào nhánh m ain.</p><div class=\"report-img-wrapper\"><img src=\"assets/extracted_media/bai4_image2.png\" alt=\"Minh họa 2\"><p class=\"report-img-caption\">Hình 2: Minh chứng trong file báo cáo</p></div></div><div class=\"pdf-page-block\" data-page=\"2\"><h4>3. Google D ocs ( Tài liệu hoá dự án)</h4><ul><li><strong class=\"label-highlight\">Thiết lập:</strong> Chuy ển đổi các trao đổi thành B ảng ph ân công ti ến độ trên G oogle D ocs, c ác</li></ul><p>thông tin về dự án, tiến độ dự án và phân công công vi ệc tuần tới sẽ được cập nhật trên</p><p>Google D ocs v ới tần suất 1 lần mỗi tuần.</p><div class=\"report-img-wrapper\"><img src=\"assets/extracted_media/bai4_image3.png\" alt=\"Minh họa 3\"><p class=\"report-img-caption\">Hình 3: Minh chứng trong file báo cáo</p></div><div class=\"report-img-wrapper\"><img src=\"assets/extracted_media/bai4_image4.png\" alt=\"Minh họa 4\"><p class=\"report-img-caption\">Hình 4: Minh chứng trong file báo cáo</p></div></div><div class=\"pdf-page-block\" data-page=\"3\"><p>Ảnh tiến độ công vi ệc của nhóm tr ên G oogle D ocs</p><div class=\"report-img-wrapper\"><img src=\"assets/extracted_media/bai4_image5.png\" alt=\"Minh họa 5\"><p class=\"report-img-caption\">Hình 5: Minh chứng trong file báo cáo</p></div></div><div class=\"pdf-page-block\" data-page=\"4\"><p>Ảnh tiến độ công vi ệc của nhóm tr ên G oogle D ocs</p><div class=\"report-img-wrapper\"><img src=\"assets/extracted_media/bai4_image6.png\" alt=\"Minh họa 6\"><p class=\"report-img-caption\">Hình 6: Minh chứng trong file báo cáo</p></div></div><div class=\"pdf-page-block\" data-page=\"5\"><h3>II. Quản lý tác vụ & Tương t ác cá nhân</h3><ul><li>Trong qu á trình th ực hiện dự án, em lu ôn phản hồi tin nh ắn về công v iệc và thông b áo tiến</li></ul><p>độ công vi ệc nhanh nh ất có thể để dây chuy ền công việc không b ị gián đoạn.</p><div class=\"report-img-wrapper\"><img src=\"assets/extracted_media/bai4_image7.png\" alt=\"Minh họa 7\"><p class=\"report-img-caption\">Hình 7: Minh chứng trong file báo cáo</p></div></div><div class=\"pdf-page-block\" data-page=\"6\"><h3>III. Ph ân tích Thách th ức & Gi ải pháp</h3><h4>1. Thách th ức 1: R ủi ro h ỏng cấu trúc hệ thống (Conflict code ) do làm vi ệc đồng th ời</h4><ul><li><strong class=\"label-highlight\">Phân tích:</strong> Khi em (viết Controller) và K ế Đức (viết Model) cùng s ửa chung m ột file c ấu</li></ul><p>hình ho ặc file liên k ết, nếu tải code đè lên nhau s ẽ làm h ỏng toàn b ộ luồng ch ạy của chương</p><p>trình (Merge Conflict).</p><ul><li><strong class=\"label-highlight\">Giải pháp:</strong> Áp d ụng nghiêm ng ặt quy t ắc Branching trên GitHub. Chúng em không bao</li></ul><p>giờ code tr ực tiếp trên nhánh main . Khi c ần ghép n ối giao di ện FXML c ủa Đạt với</p><p>Controller c ủa em, em luôn Pull nhánh DatGB  về máy c ục bộ (local), g ắn logic, ch ạy thử</p><p>thành công r ồi mới đẩy ngư ợc lên.</p><div class=\"report-img-wrapper\"><img src=\"assets/extracted_media/bai4_image8.png\" alt=\"Minh họa 8\"><p class=\"report-img-caption\">Hình 8: Minh chứng trong file báo cáo</p></div></div><div class=\"pdf-page-block\" data-page=\"7\"><h4>2. Th ách th ức 2: Kh ó tra c ứu quy ết định cũ trên ứng dụng chat</h4><ul><li><strong class=\"label-highlight\">Phân tích:</strong> Thói quen chat liên t ục trên Discord khi ến những thông tin k ỹ thuật quan tr ọng</li></ul><p>(như th ống nh ất dùng ki ểu dữ liệu gì cho balance , quy t ắc đặt tên bi ến) thư ờng bị chìm</p><p>nghỉm sau các tin nh ắn giao ti ếp thông thư ờng.</p><ul><li><strong class=\"label-highlight\">Giải pháp:</strong> Định hình l ại văn hóa giao ti ếp. Những th ông tin c ần thiết cho d ự án và tiến độ</li></ul><p>công v iệc (Code đã push) sẽ được nhắn tại Discord,  bất kì ch ốt hạ nào v ề biến hay c ấu trúc</p><p>database đ ều phải được ghim  lại ngay l ập tức, còn nh ững vấn đề và thắc mắc trong khi l àm</p><p>dự án th ì có thể dùng M essenger để giải quyết tức thì, không để ảnh hướng tới tiến độ công</p><p>việc.</p><h4>3. Thách th ức 3: B ất đồng bộ môi trư ờng ch ạy Java</h4><ul><li><strong class=\"label-highlight\">Phân tích:</strong> Môi trư ờng máy tính c ủa mỗi ngư ời khác nhau, đôi lúc d ự án ch ạy mư ợt trên</li></ul><p>máy tính c ủa em nhưng khi thành viên khác Clone t ừ GitHub v ề lại báo l ỗi thiếu thư vi ện</p><p>Maven.</p><ul><li><strong class=\"label-highlight\">Giải pháp:</strong> Cấu trúc l ại file pom.xml  một cách h ệ thống cho c ả 3 module ( client , server ,</li></ul><p>shared ) và vi ết một file README.md  ngắn gọn ngay trên GitHub hư ớng dẫn các bư ớc</p><p>đồng bộ thư vi ện chung.</p><div class=\"report-img-wrapper\"><img src=\"assets/extracted_media/bai4_image9.png\" alt=\"Minh họa 9\"><p class=\"report-img-caption\">Hình 9: Minh chứng trong file báo cáo</p></div></div><div class=\"pdf-page-block\" data-page=\"8\"><div class=\"report-img-wrapper\"><img src=\"assets/extracted_media/bai4_image10.png\" alt=\"Minh họa 10\"><p class=\"report-img-caption\">Hình 10: Minh chứng trong file báo cáo</p></div></div>"
  },
  "bai5": {
